...
const Footer: React.FC = () => {
    return (
        <footer className='bg-light-200 dark:bg-dark-200 py-12'>
            <div className='container mx-auto px-4'>
                <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
                    ...
                    <div className='md:col-span-2'>
                        ...
                        <p className='text-dark-300 dark:text-light-200 mb-4'>
                            Blog chia sẻ kiến thức lập trình chuyên sâu về
                            React, TypeScript, Node.js và các công nghệ web hiện
                            đại. Nơi cập nhật những xu hướng mới nhất trong
                    ...
                    {/* Liên kết nhanh */}
                    <div>
                        <h4 className='text-lg font-bold mb-4 text-dark-300 dark:text-light-100 font-mono'>
                            Liên kết nhanh
                        </h4>
                ...
                <div className='mt-8 pt-8 border-t border-light-300 dark:border-dark-300'>
                    <p className='text-center text-dark-300 dark:text-light-200'>
                        &copy; {new Date().getFullYear()} DevBlog. Tất cả các
                        quyền được bảo lưu.
                    </p>
                </div>
            </div>
