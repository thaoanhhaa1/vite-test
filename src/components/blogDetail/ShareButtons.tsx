    ...
    >
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <a 
          ...
          className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-500 text-white hover:opacity-90 transition-opacity"
        ...
        <button 
          ...
          className="flex items-center justify-center w-10 h-10 rounded-full bg-dark-300 dark:bg-light-200 text-light-100 dark:text-dark-300 hover:opacity-90 transition-opacity"
